...
* [GitHub Issues](https://github.com/nubleer/revel/issues)
...
```
$ go get github.com/nubleer/revel                        # Install Revel
$ cd $GOPATH/src/github.com/nubleer/revel                # Change directory to revel repo
...
```
$ go test github.com/nubleer/revel
```

Refer to the
[Travis configuration](https://github.com/nubleer/revel/blob/master/.travis.yml)
...
[issues](https://github.com/nubleer/revel/issues?labels=contributor+ready&page=1&state=open).
